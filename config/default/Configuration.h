...
#define STRING_CONFIG_H_AUTHOR __DATE__ " " __TIME__ // Who made the changes.
#define STRING_CONFIG_H_AUTHOR "(Custodio, Ricardo)"
...
//#define MAGNETIC_PARKING_EXTRUDER
  ...
  //#define MANUAL_SOLENOID_CONTROL                   // Manual control of docking solenoids with M380 S / M381
    ...
    //#define MANUAL_SOLENOID_CONTROL                   // Manual control of docking solenoids with M380 S / M381
	//@diff #define PARKING_EXTRUDER_SECURITY_RAISE 5           // Z-raise before parking
	//@diff #define HOTEND_OFFSET_Z { 0.0, 1.3 }                // Z-offsets of the two hotends. The first must be 0.
...
//  #define DEFAULT_bedKd 305.4
  ...
  //120V 250W silicone heater into 4mm borosilicate (MendelMax 1.5+)
  //from pidautotune
  #define DEFAULT_bedKp 142.89
  #define DEFAULT_bedKi 27.69
  #define DEFAULT_bedKd 491.63
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 4000, 805 }
...
#define PREHEAT_1_FAN_SPEED   255 //0 Value from 0 to 255

#define PREHEAT_2_LABEL       "ABS"
#define PREHEAT_2_TEMP_HOTEND 230 //240
#define PREHEAT_2_TEMP_BED    100 //110
#define PREHEAT_2_FAN_SPEED   255 //0  Value from 0 to 255
...
//
//#define ENCODER_STEPS_PER_MENU_ITEM 5 //1
